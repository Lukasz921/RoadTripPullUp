...
public class ArchitectureTests
{
    ...
    {
        // Arrange
        var assembly = typeof(Core.Entities.User).Assembly; // Wskazujemy dowolną klasę z projektu Core
    ...
    public void Application_Should_Not_HaveDependencyOnInfrastructureOrApi()
    {
        ...
        var assembly = typeof(Application.Interfaces.Trip.ITripService).Assembly;
