  ...
  return (
    <div className="flex aspect-square flex-col justify-between rounded-[2.5rem] bg-[#f7fbf0] p-8 text-[#12351f] shadow-2xl shadow-black/25">
      <div>
        ...
        <h1 className="mt-4 text-5xl font-black leading-[0.92] md:text-7xl">Share the road, split the cost.</h1>
        <p className="mt-5 text-lg leading-8 text-emerald-950/70">Join thousands of people sharing rides across the country.</p>
      </div>
